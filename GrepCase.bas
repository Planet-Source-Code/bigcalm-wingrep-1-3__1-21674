...
Public Function GrepCaseSensitive(RegularExpression As String, FileName As String, _
...
Dim RegExp() As String    ' Regular expressions (array of 10 possible, split from passed RegularExpression)
...
Dim InputLine2 As String ' Temporary string for read-ahead purposes.
    ...
    '-------------------------------------
    GrepCaseSensitive = MatchingLines
    Exit Function
ErrHandler:
